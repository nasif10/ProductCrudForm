                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            ...
                            <asp:LinkButton ID="btnOk" runat="server" Style="margin-top: 23px;" CssClass="btn btn-sm btn-primary" OnClick="btnOk_Click">Ok</asp:LinkButton>
                        </div>
                    </div>
                </div>
                    ...
                    <asp:GridView runat="server" id="gvProducts"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Category">  
                                <ItemTemplate>  
                                    <asp:Label ID="gvlblCategory" runat="server" Text='<%#Eval("Category") %>'></asp:Label>  
                                </ItemTemplate>  
                                <EditItemTemplate>  
                                    <asp:DropDownList ID="gvddlCategory" runat="server" DataTextField="Name" DataValueField="Id" Width="100px" CssClass="form-control form-control-sm chosen-select"></asp:DropDownList>
                                </EditItemTemplate>  
                            </asp:TemplateField>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <asp:Button class="btn btn-sm btn-primary w-auto" ID="btnSubmit" runat="server" Text="Save"
