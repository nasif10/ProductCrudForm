...
namespace ProductCrudForm.Reports
{
    public partial class RptViewer : System.Web.UI.Page
    {
        ...
        protected void PDF()
        {
            ...
            Response.AddHeader("content-disposition", $"attachment; filename=PCF_{DateTime.Now.ToString("yyyyMMddHHmmss")}.pdf");
        ...
        protected void Excel()
        {
            Response.Clear();
            Response.Buffer = true;
            Response.AddHeader("content-disposition", $"attachment;filename=PCF_{DateTime.Now.ToString("yyyyMMddHHmmss")}.xls");
            Response.Charset = "";
